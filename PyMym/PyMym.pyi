...
def module_aob_scan(pid: typing.SupportsInt, module_name: str = None, pattern: pattern_type = None, mask: str  = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False) -> int:
    ...
    addr3 = module_aob_scan(pid=pid, module_name=module, pattern=sval, result_instance=1) # gets 2nd instance
    ```
...
def heap_aob_scan(pid: typing.SupportsInt, pattern: pattern_type = None, mask: str  = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False) -> int:
    ...
    addr3 = heap_aob_scan(pid=pid, pattern=sval, result_instance=1) # gets 2nd instance
    ```
...
def stack_aob_scan(pid: typing.SupportsInt, pattern: pattern_type = None, mask: str  = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False) -> int:
    ...
    sval = pack_int(val=522, big_endian=False)
    addr3 = stack_aob_scan(pid=pid, pattern=sval, result_instance=1) # gets 2nd instance
    ```
...
@overload
def read_double(application_name: str, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> float | list[float]:
    """"""
@overload
def read_float(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> float | list[float]:
    """Returns a float located at a given address in a process"""
@overload
def read_float(application_name: str, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> float | list[float]:
    """"""
@overload
def read_int(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """Returns an integer located at a given address in a process"""
@overload
def read_int(application_name: str, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """"""
@overload
def read_long(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """Returns a long located at a given address in a process"""
@overload
def read_long(application_name: str, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """"""
@overload
def read_longlong(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """Returns a long long located at a given address in a process"""
@overload
def read_longlong(application_name: str, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
    """"""
@overload
def read_short(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1, big_endian: bool = False) -> int | list[int]:
...
def write_bytes(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: pattern_type = None, hex_string: bool = False, flip_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    ...
    Example:
    ```python
    writeBytes(pid=pid, memory_address=someAddress, val=[0x1])
    bl = [0x10, 0xFF]
    # writes len(val) - n 0s to reach n total bytes, 4 in this case
    writeBytes(pid=pid, memory_address=someAddress, val=b1, n=4)
    b2 = "10 FF" # set hex_string=True
    writeBytes(pid=pid, memory_address=someAddress, val=b2, hex_string=True)
    b3 = "Hello, world!"
    writeBytes(pid=pid, memory_address=someAddress, val=b3)
...
@overload
def write_double(application_name: str, memory_address: typing.SupportsInt = None, val: typing.SupportsFloat | list[typing.SupportsFloat] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """"""
@overload
def write_float(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: typing.SupportsFloat | list[typing.SupportsFloat] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """Writes a float to a given location in a process, returns true if the operation succeeded."""
@overload
def write_float(application_name: str, memory_address: typing.SupportsInt = None, val: typing.SupportsFloat | list[typing.SupportsFloat] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """"""
@overload
def write_integer(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """Writes an integer to a given location in a process, returns true if the operation succeeded."""
@overload
def write_integer(application_name: str, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """"""
@overload
def write_long(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """Writes a long to a given location in a process, returns true if the operation succeeded."""
@overload
def write_long(application_name: str, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """"""
@overload
def write_longlong(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """Writes a long long to a given location in a process, returns true if the operation succeeded."""
@overload
def write_longlong(application_name: str, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
    """"""
@overload
def write_short(pid: typing.SupportsInt, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, big_endian: bool = False, n: typing.SupportsInt = 1) -> bool:
...
def pack_float(val: typing.SupportsFloat, big_endian: bool = False) -> list[int]:
    """Packs a float into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_double(val: typing.SupportsFloat, big_endian: bool = False) -> list[int]:
    """Packs a double into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_short(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs a short into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_int(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs an int into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_long(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs a long into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_longlong(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs a long long into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_ushort(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs an unsigned short into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_uint(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs an unsigned int into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_ulong(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs an unsigned long into an array of ints which can be used for any of the 'AOB Scan' functions"""

def pack_ulonglong(val: typing.SupportsInt, big_endian: bool = False) -> list[int]:
    """Packs an unsigned long long into an array of ints which can be used for any of the 'AOB Scan' functions"""

def unpack_float(val: list[int], big_endian: bool = False) -> float:
    """Unpacks an array of ints into a float"""

def unpack_double(val: list[int], big_endian: bool = False) -> float:
    """Unpacks an array of ints into a double"""

def unpack_short(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into a short"""

def unpack_int(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into an int"""

def unpack_long(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into a long"""

def unpack_longlong(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into a long long"""

def unpack_ushort(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into an unsigned short"""

def unpack_uint(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into an unsigned int"""

def unpack_ulong(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into an unsigned long"""

def unpack_ulonglong(val: list[int], big_endian: bool = False) -> int:
    """Unpacks an array of ints into an unsigned long long"""
...
class ProcessWrapper:
    ...
    def read_float(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> float | list[float]:
        """Reads 'n' floats at the given 'memory_address', returns a list of floats regardless 'n'"""

    def read_double(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> float| list[float]:
        """Reads 'n' doubles at the given 'memory_address', returns a list of doubles regardless 'n'"""

    def read_short(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' shorts at the given 'memory_address', returns a list of shorts regardless 'n'"""

    def read_int(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' ints at the given 'memory_address', returns a list of ints regardless 'n'"""

    def read_long(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' longs at the given 'memory_address', returns a list of longs regardless 'n'"""

    def read_longlong(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' long longs at the given 'memory_address', returns a list of long longs regardless 'n'"""

    def read_uint(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' unsigned ints at the given 'memory_address', returns a list of unsigned ints regardless 'n'"""

    def read_ushort(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
        """Reads 'n' unsigned shorts at the given 'memory_address', returns a list of unsigned shorts regardless 'n'"""

    def read_ulong(self, memory_address: typing.SupportsInt = None, n: typing.SupportsInt = 1) -> int | list[int]:
    ...
    def write_bytes(self, memory_address: typing.SupportsInt = None, val: pattern_type = None, n: typing.SupportsInt = 1, overwrite_endian: bool = False, hex_string: bool = False) -> bool:
        ...
        proc.writeBytes(memory_address=someAddress, val=[0x1])
        bl = [0x10, 0xFF]
        # writes len(val) - n 0s to reach n total bytes, 4 in this case
        proc.writeBytes(memory_address=someAddress, val=b1, n=4)
        b2 = "10 FF" # set hex_string=True
        proc.writeBytes(memory_address=someAddress, val=b2, hex_string=True)
        b3 = "Hello, world!"
        proc.writeBytes(memory_address=someAddress, val=b3)

        ```"""

    def write_float(self, memory_address: typing.SupportsInt = None, val: typing.SupportsFloat | list[typing.SupportsFloat] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining floats"""

    def write_double(self, memory_address: typing.SupportsInt = None, val: typing.SupportsFloat | list[typing.SupportsFloat] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining doubles"""

    def write_short(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining shorts"""

    def write_int(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining ints"""

    def write_long(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining long"""

    def write_longlong(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining long longs"""

    def write_uint(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining unsigned ints"""

    def write_ushort(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining unsigned shorts"""

    def write_ulong(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
        """writes 'val' at given 'memory_address', if 'n' is greater than len(val), then 0's fill the remaining unsigned longs"""

    def write_ulonglong(self, memory_address: typing.SupportsInt = None, val: typing.SupportsInt | list[typing.SupportsInt] = None, n: typing.SupportsInt = 1) -> bool:
    ...
    def module_aob_scan(self, module_name: str = None, pattern: pattern_type = None, mask: str = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False):
        ...
        sval = pack_int(val=522, big_endian=False) # 'big_endian' is False by default
        addr3 = proc.module_aob_scan(module_name=module, pattern=sval,  result_instance=1) # gets 2nd instance
        ```
    ...
    def stack_aob_scan(self, pattern: pattern_type = None, mask: str = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False):
        ...
        sval = pack_int(val=522, big_endian=False) # 'big_endian' is False by default
        addr3 = proc.stack_aob_scan(pattern=sval, result_instance=1) # gets 2nd instance
        ```
    ...
    def heap_aob_scan(self, pattern: pattern_type = None, mask: str = None, offset: typing.SupportsInt = 0, result_instance: typing.SupportsInt = 0, flip_endian: bool = False, hex_string: bool = False):
        ...
        addr2 = proc.heap_aob_scan(pattern="Hello, World") # defaults mask to 'x' * len(pattern)
        sval = pack_int(val=522, big_endian=False)
        addr3 = proc.heap_aob_scan(pattern=sval, result_instance=1) # gets 2nd instance
        ```
